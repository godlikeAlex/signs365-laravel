    ...
    return $form
      ->schema([
        ...
        Forms\Components\Select::make('city_id')
          ...
          ->preload()
          ->reactive()
          ->helperText('Warning! After choosing a city, all order items will be reset.')
...
//                            })
              ->afterStateUpdated(function ($state, callable $set, Closure $get) {
                $productVariantPrice = ProductVariant::find($get('product_variant_id'));
    ...
    return $table
      ->columns([
        ...
        Tables\Columns\TextColumn::make('user.name')
          ...
          ->label('User')
          ->url(
            fn(Order $record) => UserResource::getUrl('edit', ['record' => $record->user])
          ),
